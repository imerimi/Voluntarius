...
<html lang="en">
	<head lang="en">
		...
		<title>Existing Banner</title>
		<link rel="stylesheet" href="Style/reset.css" />
		<link rel="stylesheet" type="text/css" href="Style/22_admin_banner_existing.css"/>
	...
	<body>
		...
		<div class="container">
			...
			<div class="admin_banner_approval_menu">
				<?php
					$sql = "SELECT * FROM banner WHERE banner_approval_status=1";
					$result=mysqli_query($link,$sql);
