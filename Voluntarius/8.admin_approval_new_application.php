<?php 
	...
	if (isset($_POST["action"]))
	{
		if($_POST["action"]=="Reject"){
			...
			$sql = "UPDATE admin SET admin_approval_status=1 WHERE admin_email='".$_POST["id"]."'";
			mysqli_query($link,$sql);
			header('Location: '.$_SERVER["PHP_SELF"], true, 303);
		}
	}
	
	//$sql = "UPDATE admin SET admin_approval_status=1 WHERE admin_email='katherine@gmail.com'";
	//mysqli_query($link,$sql);
?>
...
<html lang="en">
	<head lang="en">
		...
		<link rel="stylesheet" type="text/css" href="Style/17_admin_approval_new_application.css"/>
	...
	<body>
		...
		<div class="container">
			...
			<div class="admin_application_menu">
				...
				<?php 
					$sql = "SELECT * FROM ADMIN WHERE admin_approval_status=0";
