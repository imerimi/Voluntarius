...
<html lang="en">
	<head lang="en">
		...
		<link rel="stylesheet" type="text/css" href="Style/17_admin_approval_main.css"/>
	...
	<body>
		...
		<div class="container">
			...
			<div class="admin_menu">
				<h1>Admin</h1>
				<p><a href="8.admin_approval_new_application.php">New Admin Applications</a></p>
				<p><a href="8.existing_admin_list.php">Existing Admins</a></p>
			</div>
